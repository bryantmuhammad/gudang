                        ...
                        <div class="border-top border-gray-200 pt-4 mt-4">
                            <div class="invoice-header">
                                <div>
                                    ...
                                    <strong>{{ $barang_keluar->created_at->isoFormat('dddd, D MMMM Y') }}</strong>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-top border-gray-200 mt-4 py-2">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <strong>
                                        {{ $barang_keluar->toko->nama_toko }}
                                    </strong>
                                    <p class="fs-sm">
                                        {{ $barang_keluar->toko->alamat_toko }}
                                        <br>
                                        {{
                                        $barang_keluar->toko->no_telepon_toko }}
                                    </p>
                                </div>
                        ...
                        <table class="table border-bottom border-gray-200 mt-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">{{ rupiah($detail_barang_keluar->jumlah *
