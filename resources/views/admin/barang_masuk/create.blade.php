    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('dashboard.kategori.index') }}">Kategori</a></div>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.kategori.store') }}" method="POST" id="formbarangmasuk">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <x-forms.input-group id="tanggal_barang_masuk" name="tanggal_barang_masuk"
                                    required="required" id="name" type="date" placeholder="Masukan Tanggal Barang Masuk"
                                    label="Tanggal Barang Masuk" value="{{ date('Y-m-d') }}">
                                </x-forms.input-group>
                            </div>
